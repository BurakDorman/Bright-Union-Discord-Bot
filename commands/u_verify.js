...
exports.run = async (client, message, args) => {
  ...
  if (message.channel.id === "901146961384710185") {
    ...
    const verified = new Discord.MessageEmbed()
      .setColor("BLUE")
      .setAuthor("Bright Union DeFi Insurance Aggregator", "https://hiluin.com/discord-assets/brighttoken_200x200.png", "https://brightunion.io")
	...
	.setFooter('Stay safe with Bright Union.', 'https://hiluin.com/discord-assets/lock_with_key.png')
